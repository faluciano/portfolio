...
const Footer = () => {
  return (
    <div className="mx-auto grid grid-cols-12 gap-5 p-11">
      ...
      <button className="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded sm:col-span-6">
          <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" className="w-11" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
      ...
      <a href="https://www.linkedin.com/in/felix-luciano-salomon-6266021b6/">
        <button className="bg-blue-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded sm:col-span-6">
            <svg className="w-11 h-11 fill-current" role="img" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
